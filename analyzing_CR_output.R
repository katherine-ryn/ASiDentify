...
# Purpose: This script uses the nested_cv.R section 3 output from all CR genes and generates the AUROC/AUPRC curves and output supp. tables. 
#          
# ---
...
write.csv(genes, "./tables/csv/CR_Predictions.csv", 
          row.names = F)
write.csv(autism_tb, "./tables/csv/CR_Odds_Ratios.csv", 
          row.names = F)
write.csv(autism_CIs, "./tables/csv/CR_CIs.csv", 
          row.names = F)
write.csv(AUROC_AUPRC, "./tables/csv/CR_AUROC_AUPRC.csv", 
          row.names = F)
write.csv(genes, "./tables/csv/CR_lambda.csv", 
          row.names = F)
...
asd_roc <- plotROC(autism_res, 38, 39)
asd_roc
asd_pr <- plotPR(autism_res, 38, 39)
asd_pr
