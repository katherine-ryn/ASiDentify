...
autism_res <- trainCV(genes, K = 5, indep_var = "autism", standardized_col = c(6:29), feature_col = c(6:30))
...
autism_res_CompRBP <- trainCV(CompRBP, K = 5, indep_var = "autism", standardized_col = c(8:31), feature_col = c(8:32))
...
autism_res_HCRBP <- trainCV(HCRBP, K = 5, indep_var = "autism", standardized_col = c(8:31), feature_col = c(8:32))
...
autism_res_CRBP <- trainCV(CRBP, K = 5, indep_var = "autism", standardized_col = c(8:31), feature_col = c(8:32))
...
autism_res_NCRBP <- trainCV(NCRBP, K = 5, indep_var = "autism", standardized_col = c(8:31), feature_col = c(8:32))
...
# Train machine learning model
autism_res <- trainCV(genes, K = 5, indep_var = "autism", standardized_col = c(20:43), feature_col = c(20:44))
autism_pred <- do.call("rbind", autism_res$predictions)
autism_pred <- autism_pred %>% arrange(-predictions)
